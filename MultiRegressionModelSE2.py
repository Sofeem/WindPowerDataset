# -*- coding: utf-8 -*-
"""
Created on Tue Mar 30 18:21:22 2021
...
WindSE2ML = Winddata[Winddata ['region'] == 'SE2']



WindSE2testML = WindSE2ML.copy()
WindSE2testML.drop(['time', 'cluster', 'region'],axis = 1, inplace=True)
...
for column in WindSE2testML.columns:
    WindSE2testML[column] = WindSE2testML[column]  / WindSE2testML[column].abs().max()
      
# view normalized data
#print(WindSE2test)

normalized_dfML = WindSE2testML
