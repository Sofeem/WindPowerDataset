...
# WindSE3.plot.scatter(x = 'Temperature' , y = 'power-production', xlim = (200,350), ylim = (0,1500), s = 0.5)
# WindSE3.plot.scatter(x = 'RelativeHumidity' , y = 'power-production', ylim = (0,1500), s = 0.5)
# WindSE3.plot.scatter(x = 'Wind_U' , y = 'power-production',  ylim = (0,1500), s = 0.5)
# WindSE3.plot.scatter(x = 'Wind_V' , y = 'power-production',  ylim = (0,1500), s = 0.5)
# WindSE3.plot.scatter(x = 'CloudCover' , y = 'power-production',  ylim = (0,1500), s = 0.5)
# WindSE3.plot.scatter(x = 'WindGustSpeed' , y = 'power-production', ylim = (0,1500), s = 0.5)
...
#Finding corelation between variables 
#Price region SE3
pearsoncorrTempSE3 = WindSE3[['Temperature', 'power-production']].corr(method = 'pearson')
print(pearsoncorrTempSE3)
pearsoncorrRHSE3 = WindSE3[['RelativeHumidity', 'power-production']].corr(method = 'pearson')
print(pearsoncorrRHSE3)
pearsoncorrWUSE3 = WindSE3[['Wind_U', 'power-production']].corr(method = 'pearson')
print(pearsoncorrWUSE3)
pearsoncorrWVSE3 = WindSE3[['Wind_V', 'power-production']].corr(method = 'pearson')
print(pearsoncorrWVSE3)
pearsoncorrCCSE3 = WindSE3[['CloudCover', 'power-production']].corr(method = 'pearson')
print(pearsoncorrCCSE3)
pearsoncorrWGSSE3 = WindSE3[['WindGustSpeed', 'power-production']].corr(method = 'pearson')
print(pearsoncorrWGSSE3)
pearsoncorrPSE3 = WindSE3[['Pressure', 'power-production']].corr(method = 'pearson')
print(pearsoncorrPSE3)
#Mormalize the dataset
WindSE3test = WindSE3.copy()
WindSE3test.drop(['time', 'cluster', 'region'],axis = 1, inplace=True)




# column_maxes = WindSE3test.max()
# df_max = column_maxes.max()
# column_mins = WindSE3test.min()
# df_min = column_mins.min()
# normalized_df = (WindSE3test - df_min) / (df_max - df_min)
for column in WindSE3test.columns:
    WindSE3test[column] = WindSE3test[column]  / WindSE3test[column].abs().max()
      
# view normalized data
#print(WindSE3test)

normalized_df = WindSE3test
...
# Linear Regression using sinle values for SE3 with Temperature
...
#Linear Regression using sinle values for SE3 with RelativeHumidity 
...
#Linear Regression using sinle values for SE3 with CloudCover
...
#Linear Regression using sinle values for SE3 with Wind_U
...
#Linear Regression using sinle values for SE3 with Wind_V
...
#Linear Regression using sinle values for SE3 with WindGustSpeed
...
#Linear Regression using sinle values for SE3 with Pressure
