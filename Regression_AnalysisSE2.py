...
# WindSE2.plot.scatter(x = 'Temperature' , y = 'power-production', xlim = (200,350), ylim = (0,1500), s = 0.5)
# WindSE2.plot.scatter(x = 'RelativeHumidity' , y = 'power-production', ylim = (0,1500), s = 0.5)
# WindSE2.plot.scatter(x = 'Wind_U' , y = 'power-production',  ylim = (0,1500), s = 0.5)
# WindSE2.plot.scatter(x = 'Wind_V' , y = 'power-production',  ylim = (0,1500), s = 0.5)
# WindSE2.plot.scatter(x = 'CloudCover' , y = 'power-production',  ylim = (0,1500), s = 0.5)
# WindSE2.plot.scatter(x = 'WindGustSpeed' , y = 'power-production', ylim = (0,1500), s = 0.5)
...
#Price region SE2
pearsoncorrTempSE2 = WindSE2[['Temperature', 'power-production']].corr(method = 'pearson')
print(pearsoncorrTempSE2)
pearsoncorrRHSE2 = WindSE2[['RelativeHumidity', 'power-production']].corr(method = 'pearson')
print(pearsoncorrRHSE2)
pearsoncorrWUSE2 = WindSE2[['Wind_U', 'power-production']].corr(method = 'pearson')
print(pearsoncorrWUSE2)
pearsoncorrWVSE2 = WindSE2[['Wind_V', 'power-production']].corr(method = 'pearson')
print(pearsoncorrWVSE2)
pearsoncorrCCSE2 = WindSE2[['CloudCover', 'power-production']].corr(method = 'pearson')
print(pearsoncorrCCSE2)
pearsoncorrWGSSE2 = WindSE2[['WindGustSpeed', 'power-production']].corr(method = 'pearson')
print(pearsoncorrWGSSE2)
pearsoncorrPSE2 = WindSE2[['Pressure', 'power-production']].corr(method = 'pearson')
print(pearsoncorrPSE2)
#Mormalize the dataset
WindSE2test = WindSE2.copy()
WindSE2test.drop(['time', 'cluster', 'region'],axis = 1, inplace=True)

# column_maxes = WindSE2test.max()
# df_max = column_maxes.max()
# column_mins = WindSE2test.min()
# df_min = column_mins.min()
# normalized_df = (WindSE2test - df_min) / (df_max - df_min)
for column in WindSE2test.columns:
    WindSE2test[column] = WindSE2test[column]  / WindSE2test[column].abs().max()
      
# view normalized data
#print(WindSE2test)

normalized_df = WindSE2test
...
# Linear Regression using sinle values for SE2 with Temperature
...
#Linear Regression using sinle values for SE2 with RelativeHumidity 
...
#Linear Regression using sinle values for SE2 with CloudCover
...
#Linear Regression using sinle values for SE2 with Wind_U
...
#Linear Regression using sinle values for SE2 with Wind_V
...
#Linear Regression using sinle values for SE2 with WindGustSpeed
...
#Linear Regression using sinle values for SE2 with Pressure
