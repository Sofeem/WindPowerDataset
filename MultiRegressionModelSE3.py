...
WindSE3ML = Winddata[Winddata ['region'] == 'SE3']



WindSE3testML = WindSE3ML.copy()
WindSE3testML.drop(['time', 'cluster', 'region'],axis = 1, inplace=True)
...
for column in WindSE3testML.columns:
    WindSE3testML[column] = WindSE3testML[column]  / WindSE3testML[column].abs().max()
      
# view normalized data
#print(WindSE3test)

normalized_dfML = WindSE3testML
