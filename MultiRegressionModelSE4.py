...
WindSE4ML = Winddata[Winddata ['region'] == 'SE4']



WindSE4testML = WindSE4ML.copy()
WindSE4testML.drop(['time', 'cluster', 'region'],axis = 1, inplace=True)
...
for column in WindSE4testML.columns:
    WindSE4testML[column] = WindSE4testML[column]  / WindSE4testML[column].abs().max()
      
# view normalized data
#print(WindSE4test)

normalized_dfML = WindSE4testML
